class ingredient_field_injector {
    ...
    new_field(event) {
        ...
        ing_box.innerHTML += "<div class=\"d-flex flex-row\" name=\"ing_row\"><form onsubmit=\"return false;\" id=\"" + form_name + "\"><div class=\"input-group\"><input style=\"width:100%\" class=\"ingredientTableInput\" title=\"Name\" placeholder=\"Name\" type=\"text\" name=\"name\"><input class=\"ingredientTableInput\" title=\"ABV (%)\" placeholder=\"ABV (%)\" type=\"number\" name=\"abv\"><input class=\"ingredientTableInput\" title=\"Volume (Oz)\" placeholder=\"Volume (Oz)\"  type=\"number\" name=\"volume\"></form></div></div>";
